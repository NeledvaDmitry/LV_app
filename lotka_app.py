...
- \(\beta\) — «сила» хищничества: насколько быстро хищники уменьшают численность жертв.  
- \(\gamma\) — скорость убывания популяции хищников, если нет пищи.  
- \(\delta\) — эффективность превращения съеденных жертв в прирост хищников.
